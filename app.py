...
def show():
    ...
    # Filtrar por nome do técnico (forçando string antes para evitar erros)
    df_filtrado['TECNICO'] = df_filtrado['TECNICO'].astype(str)
    ...
    # Exibir só os dois cards (% OK e % Pendentes)
