...
# ================== CSS: POWER BI DARK (TEXTOS DAS METRICS EM BRANCO) ==================
st.markdown("""
<style>
...
/* Forçar textos das métricas (título e valor) para branco */
...
# ---------------------------
# Função utilitária: tema Plotly Power BI Dark
# ---------------------------
