...
# --- Usuários e senhas (troque as senhas aqui) ---
users = {
    "usernames": {
        "pati": {
            "name": "Pati",
            "password": stauth.Hasher(['minha_senha123']).generate()[0]
        },
        "coordenador": {
            "name": "Coordenador",
...
authenticator = stauth.Authenticate(
    users['usernames'],
    "cookie_meupainelepi",   # nome do cookie
    "chave_secreta_meupainel",  # chave secreta para segurança
